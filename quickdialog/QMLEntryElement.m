...
#import "QMLEntryElement.h"
#import "QuickDialog.h"
@implementation QMLEntryElement  {
...
- (QMLEntryElement *)initWithTitle:(NSString *)title Value:(NSString *)value Placeholder:(NSString *)placeholder {
    self = [self init];
    if (self) {
        _title = title;
        _textValue = value;
...
- (UITableViewCell *)getCellForTableView:(QuickDialogTableView *)tableView controller:(QuickDialogController *)controller {
    ...
    QMLEntryTableViewCell *cell = [tableView dequeueReusableCellWithIdentifier:@"QuickformEntryElement"];
    if (cell==nil){
        cell = [[QMLEntryTableViewCell alloc] init];
    }
